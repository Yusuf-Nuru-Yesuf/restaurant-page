  ...
  const beverages = [
    {
      ...
      description:
        "Made from 100% freshly squeezed oranges, providing a vitamin-packed boost to your day.",
      price: 3,
    },
    {
      name: "Apple & Carrot Juice",
      description:
        "A healthy, naturally sweet combination of crisp apples and fresh carrots, packed with" +
        " nutrients.",
      price: 4,
    },
    {
      ...
      description:
        "A soothing blend of chamomile flowers and natural honey, perfect for relaxation.",
      price: 5,
    },
  ];
...
export function side() {
  ...
  const sides = [
    ...
    },
    {
      ...
      description:
        "Crispy vegetable spring rolls served with a sweet chili dipping sauce.",
      price: 7,
    },
    {
      name: "Falafel Bites",
      description:
        "Crispy on the outside, tender on the inside, these falafel bites are served with a tangy" +
        " tahini sauce.",
      price: 6,
    },
  ];
  ...
  const mainDishes = [
    {
      ...
      description:
        "Juicy, marinated chicken grilled to perfection and wrapped in warm flatbread with fresh" +
    ...
    },
    {
      name: "Beef Burger",
      description:
        "A tender, halal beef patty topped with lettuce, tomato, and cheese, served on a soft bun" +
    ...
    },
    {
      ...
      description:
        "Grilled chicken breast served over crisp romaine lettuce, tossed in a creamy Caesar" +
    ...
    },
    {
      name: "Falafel Wrap",
      description:
        "Crispy falafel balls wrapped in a warm pita with hummus, fresh vegetables, and a drizzle" +
        " of tahini sauce.",
      price: 9,
    },
    {
      ...
      description:
        "Fresh salmon fillet seasoned with a spicy blend of herbs, grilled to perfection, and" +
    ...
    },
    {
      ...
      description:
        "A warm tortilla filled with melted cheese, grilled peppers, onions, and mushrooms, served" +
    ...
    },
    {
      ...
      description:
        "Tender grilled chicken tossed in a rich and creamy Alfredo sauce, served over fettuccine" +
